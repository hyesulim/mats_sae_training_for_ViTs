...
#     if len(png_files) < 9:
#         raise ValueError(f"There are less than 9 PNG files in the source directory for {grid_filename}.")
#         # print("There are less than 9 PNG files in the source directory.")
#         # return
...
def create_image_grid(source_directory, target_directory, grid_filename="image_grid.png", spacing=10):
    ...
    # Pick the first 9 PNG files or fewer if less than 9 are available
    png_files = png_files[:9]
