...
cfg = ViTSAERunnerConfig(
    ...
    from_pretrained_path = "/home/hgf_hmgu/hgf_rmp8147/dev/mats_sae_training_for_ViTs/checkpoints/93iv5zg1/final_sparse_autoencoder_openai/clip-vit-large-patch14_-2_resid_65536.pt",
...
model, sparse_autoencoder, _ = ViTSparseAutoencoderSessionloader.load_session_from_pretrained(
